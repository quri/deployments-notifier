...
function notifySpine() {
  ...
  switch (NODE_ENV) {
    ...
    case "staging": {
      SPINE_ENDPOINT = `https://quri-spine-staging.herokuapp.com/deployments/${DEPLOYMENTS_APP}`;
      break;
    }
    case "ci":
    case "production": {
      SPINE_ENDPOINT = `https://quri-spine.herokuapp.com/deployments/${DEPLOYMENTS_APP}`;
      break;
    }
    default: {
